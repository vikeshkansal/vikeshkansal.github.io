...
document.getElementById("analyzeButton").addEventListener("click", function(){
    ...
    addIndividualCount("pronounCounts", pronounsCount);
    addIndividualCount("prepositionCounts", prepositionsCount);
    addIndividualCount("articleCounts", indefiniteArticlesCount);        
});
